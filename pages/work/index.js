    ...
    <div className='container mx-auto '>
      <div className='flex flex-col xl:flex-row gap-x-8 '>
        ...
        <div className='text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0 '>
          ...
          <motion.p variants={fadeIn('up', 0.4)} initial='hidden' animate='show' exit='hidden' className='mb-4 max-w-[400px] mx-auto lg:mx-0 '>And here are some projects that I am working on. There are mobile and website based ones, both of which I work as a front-end developer.</motion.p>
        </div>
